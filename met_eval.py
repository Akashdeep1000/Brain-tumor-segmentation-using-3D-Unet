...
print("start")
sys.stdout.flush()
train_img_dir = "/home/cap6412.student38/BraTS2020 Dataset/output_data/"
train_mask_dir ="/home/cap6412.student38/BraTS2020 Dataset/output_data/"

val_img_dir = "/home/cap6412.student38/BraTS2020 Dataset/output_data/"
val_mask_dir = "/home/cap6412.student38/BraTS2020 Dataset/output_data/"
...
mymodel_1 = load_model("/home/cap6412.student38/0_brats.hdf5", compile = False)
mymodel_2 = load_model("/home/cap6412.student38/1_brats.hdf5", compile = False)
mymodel_3 = load_model("/home/cap6412.student38/2_brats.hdf5", compile = False)
mymodel_4 = load_model("/home/cap6412.student38/3_brats.hdf5", compile = False)
mymodel_5 = load_model("/home/cap6412.student38/4_brats.hdf5", compile = False)

img_num = 110

img = np.load("/home/cap6412.student38/BraTS2020 Dataset/output_data/val/images/_"+str(img_num)+".npy")

mask = np.load("/home/cap6412.student38/BraTS2020 Dataset/output_data/val/masks/_"+str(img_num)+".npy")
